module "vm" {
  ...
  backend_id                     = var.instance_config.enable_lb == true ? module.lb_rule.0.backend_id : []
  frontend_ip_configuration_name = var.instance_config.enable_lb == true ? module.lb_rule.0.frontend_ip_configuration_name : []
