output "info" {
  ...
  value = {
    ...
    rg_suffix                        = local.default_instance_config.rg_suffix
    enable_zone                      = local.default_instance_config.enable_zone
    image_name                       = local.default_instance_config.image_name
    image_gallery_name               = local.default_instance_config.image_gallery_name
    image_resource_group_name        = local.default_instance_config.image_resource_group_name
    image_version                    = local.default_instance_config.image_version
