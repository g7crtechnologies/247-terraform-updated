...
locals {
  resource_group_name = terraform.workspace == "hub" ? "tfs-rg-${terraform.workspace}-${local.loc_prefix}-landingzone" : "tfs-rg-${terraform.workspace}-${local.loc_prefix}-${var.rg_suffix}"
